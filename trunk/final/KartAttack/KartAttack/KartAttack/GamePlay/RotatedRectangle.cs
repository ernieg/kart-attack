// aqcuired from http://www.xnadevelopment.com/tutorials/rotatedrectanglecollisions/rotatedrectanglecollisions.shtml
...
namespace KartAttack
{
  class RotatedRectangle
  {
    ...
    public RotatedRectangle(Rect theRectangle, float theInitialRotation)
    {
    ...
    {
        get { return new Vector2(CollisionRectangle.Left + Origin.X, CollisionRectangle.Top + Origin.Y); }
    }
